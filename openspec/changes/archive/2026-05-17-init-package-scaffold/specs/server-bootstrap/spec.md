...
> **Revision**: v2. Binary path updated to `dist/src/server.js` (Oracle F1). Concrete `protocolVersion` values supplied (Metis F-15). `notifications/initialized` scenario added (Metis F-7).
