# Spec Delta: pages-site (add-github-pages-site)

New capability — defines the GitHub Pages site, its build pipeline, and the contract that `CHANGELOG.md` is the single source of truth for changelog content.
